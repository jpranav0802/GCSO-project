...
function setup() {
  ...
  car1 = createSprite(140, 50, 200, 50);
  car1.scale = 0.3;
  car1.velocityX = 0;
  car2 = createSprite(150, 155, 200, 50);
  car2.scale = 0.3;
  car2.velocityX = 0;
  car3 = createSprite(170, 280, 200, 50);
  car3.scale = 0.3;
  car3.velocityX = 0;
  car4 = createSprite(130, 385, 200, 50);
  car4.velocityX = 0;
  car4.scale = 0.3;
